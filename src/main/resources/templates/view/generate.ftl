    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <tr class="fields">
                ...
                <td>
                    <span class="glyphicon glyphicon-remove-circle" onclick="removeField(this);"
                          style="padding-top:10px; cursor: pointer;"></span>
                </td>
            </tr>
            <tr class="add_field">
                <td colspan="5">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"
                                    onclick="location='${base_path}/code/generate'">继续添加
                            </button>
                        </div>
                    </div>
                </div>
